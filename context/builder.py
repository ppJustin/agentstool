...
class ContextBuilder:
    ...
    def __init__(
        ...
        self._encoding = tiktoken.get_encoding("cl100k_base")       #指定编码名称/也可以直接指定模型
    ...
    def build(
        ...
        system_instructions: Optional[str] = None,                      #可选系统指令
        additional_packets: Optional[List[ContextPacket]] = None        #额外自定义包
    ) -> str:
        """构建完整上下文
