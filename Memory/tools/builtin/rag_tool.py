...
class RAGTool(Tool):
    ...
    def __init__(
        ...
        collection_name: str = "rag_knowledge_base",        #用于Qdrant中集合的名称
        rag_namespace: str = "default"                      #应用层实现的逻辑隔离机制，并非Qdrant的内置功能
    ):
        super().__init__(
            name="rag",
    ...
    def _clear_knowledge_base(self, confirm: bool = False, namespace: Optional[str] = None, **kwargs) -> str:
        ...
        try:
            ...
            success = store.delete_by_namespace(namespace_id) if store else False
