...
from Memory.memory.base import BaseMemory, MemoryItem, MemoryConfig
...
class Entity:
    ...
    def __init__(
        ...
        self.entity_id = entity_id              #实体标识符
        self.name = name                        #实体名称
        self.entity_type = entity_type  # PERSON, ORG, PRODUCT, SKILL, CONCEPT等实体类型
        self.description = description          #实体描述
        self.properties = properties or {}      #额外描述
...
class Relation:
    ...
    def __init__(
        ...
        self.from_entity = from_entity                  #源头实体
        self.to_entity = to_entity                      #目标实体
        self.relation_type = relation_type              #关系类型
        self.strength = strength                        #关系强度
        self.evidence = evidence                        #证据文本
...
class SemanticMemory(BaseMemory):
    ...
    def _init_databases(self):
        ...
        try:
            ...
            # 初始化Neo4j图数据库
            from Memory.memory.storage.neo4j_store import Neo4jGraphStore
